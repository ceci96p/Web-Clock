...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 24, vars: 0, consts: [["lang", "en"], ["charset", "utf-8"], ["http-equiv", "x-ua-compatible", "content", "ie=edge"], ["name", "viewport", "content", "width=device-width, initial-scale=1, shrink-to-fit=no"], [1, "page"], [1, "container"], [1, "clock", "type1"], [1, "clock", "type2"], [1, "clock", "type3"], [1, "clock", "type4"], [1, "content"], [1, "box"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
